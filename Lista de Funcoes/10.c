/*
10. Faça uma função chamada ‘simplifica’ que recebe como parâmetro o
...
void simplificar(int numerador, int denominador)
{
    ...
    while (flag != 8) // repete enquanto todas as possibilidades de 2 ate 9 forem possiveis para simplificar os numeors
    {
