/*
    Considere um número inteiro N na base 10 e
    a sua representação na base B denotada por: (ajaj-1...a2a1a0) B.
...
int main()
{
    ...
    {
        // escrendo o vertor ao contrario para mostrar o resultado ascendente
        printf("%d", novo[voltas - i]); 
    }
