/* Conversão de Base – B para 10 sem parte fracionaria - ajbj+ aj-1bj-1+ ... + a2b2+ a1b1+ a0b0*/
...
int main()
{
    ...
    while (numero > 0)
    {
        vet[i] = (numero % 10) * (pow(base, i)); // armazena cada algarismo de acordo com a formula
