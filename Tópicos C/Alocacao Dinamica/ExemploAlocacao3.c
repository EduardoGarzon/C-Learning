/*
    Faça um programa que leia do usuário o tamanho de um vetor a ser utilizado
    e faça a alocação dinâmica de memória.
    Em seguida, leia do usuário seus valores e
...
int main()
{
    ...
    printf("Informe o tamanho da alocacao: "); // lendo o tamanho a a ser alocado
    scanf("%d", &tamanho);
    ...
    printf("\n");
    printf("Valores Pares e Impares:\n");
