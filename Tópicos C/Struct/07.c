/*
7. Faça um programa que leia um vetor com dados de 5 livros: título (máximo 30
letras), autor (máximo 15 letras) e ano. Procure um livro por título, perguntando ao
usuário qual título deseja buscar. Mostre os dados de todos os livros encontrados.
*/
...
int main()
{
    ...
    int flag = 0, resposta = 1; // flag que indica se o titulo foi encotrado e variavel de resposta para ver se o usuario quer continuar procurando
    while (resposta == 1)       // enquanto a resposta for 1 ele continua procurando o livro
    {
        flag = 0;
        printf("\nProcure o livro pelo titulo: "); // leitura do titulo
        ...
        printf("\nContinuar? [0 - nao / 1 - sim]: "); // opcao de continuar
        scanf("%d", &resposta);
        fflush(stdin);
    }
