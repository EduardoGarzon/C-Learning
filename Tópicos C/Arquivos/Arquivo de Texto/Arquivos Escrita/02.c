/*2. O IBOP realizou uma pesquisa a nível nacional. Foi entrevistado um
certo número de pessoas. Cada pessoa respondeu ao seguinte
questionário:
Sexo: ( )M ( )F
Idade: ____ anos
Fumante: ( )S ( )N
Considere um arquivo testo de registros (denominado “ibop.txt”) que
