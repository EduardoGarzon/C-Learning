/*
    Faça um programa que crie uma lista encadeada para armazenar os
    dados de carros: marca (máximo 15 letras), ano e preço.
    Todas as informações devem ser gravadas em um arquivo txt.
...
void pesquisa(LISTA *lista)
{
    ...
    printf("\n");
    printf("CARROS NA FAIXA DE PRECO: \n");
