...
/*
    ...
    Eles são usados para garantir que um determinado bloco de código seja incluído no programa apenas uma vez, evitando problemas de duplicação de definições e redefinições.
*/
#ifndef PERSON_H
#define PERSON_H
...
typedef struct
{
    ...
    /*
        ...
        É uma forma flexível de referenciar e invocar funções dinamicamente em tempo de execução.
