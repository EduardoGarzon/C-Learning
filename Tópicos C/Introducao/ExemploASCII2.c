...
int main()
{
    /*
        ...
        A tabela ASCII estendida utiliza o unsigned assim os valores podem ser representados de 0 ate 255, assim a maioria dos caracteres acentuados podem ser representados.
    */
