...
{
    int codigo;
    Data dataAss; // possui o tipo Data (Estrutura Data)
    char cargo[50];
    float salario;
} Contrato;
...
{
    char nome[50];
    Data dataNas;   // tipo Data para Estrutura Dara
    Endereco end;   // tipo Endereco para Estrutura Endereco
    Contrato contr; // tipo Contrato para Estrutura Contrato
} Pessoa;
...
typedef struct no
{
    Pessoa p; // tipo Pessoa para Estrutura Pessoa
    struct no *proximo;
} No;
