/*
8. Faça uma função que receba dois números inteiros positivos por parâmetro
...
int somador()
{
    ...
    {
        printf("\nOs valores nao podem ser iguais."); // erro quando os valores sao iguais
    }
...
int main()
{
    ...
    printf("\nSoma dos valores existentes entre %d e %d: %d", n1, n2, soma);
}