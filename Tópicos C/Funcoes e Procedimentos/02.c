/*
2. Faça um programa que tenha uma função double potencia(double x, int n)
e a utilize para calcular o valor de um número real elevado a um número
inteiro.

 o double é para números grande e com uma precisão de 15 casas decimais, para pegar um número double coloque lf de long float : scanf("%lf",&num);
*/
...
double main()
{
    ...
    printf("Resultado da potencia: %.2f", resultado);
