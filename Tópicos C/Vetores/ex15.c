/* 15 Ler um vetor R de 5 elementos contendo o gabarito da LOTO. A seguir ler um vetor A de 10
elementos contendo uma aposta. Por fim, imprima quantos pontos fez o apostador.
Exemplo: R = 4 12 34 25 17 (gabarito);  A = 3 17 55 21 34 4 27 29 20 11 (aposta);  Saída: 3 pontos */
...
int main()
{
    ...
    printf("Pontuacao: %i", ponto); // Pontuacao.
