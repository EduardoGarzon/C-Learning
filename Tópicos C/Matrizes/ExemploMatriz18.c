/*
    Escreva um algoritmo que leia uma matriz quadrada 5 x 5 de elementos reais,
    divida cada elemento de uma linha da matriz pelo elemento da diagonal principal desta linha e imprima a matriz assim modificada.
...
int main()
{
    ...
    printf("\n");
    printf("Matriz linha / elemento da diagonal principal correspondente:\n");
