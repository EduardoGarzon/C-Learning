/*
    Faça um algoritmo que preencha automaticamente uma matriz A 10x10
    e realize as seguintes trocas armazenando o resultado em uma matriz B:
...
int main()
{
    ...
    for (i = 0; i < 10; i++)
    {
        for (j = 0; j < 10; j++)
        {
            // Gerando valores aleatorios para a matriz 10x10 com rand semente 1
            matriz[i][j] = rand() % 10;
            B[i][j] = matriz[i][j];
        }
    }
