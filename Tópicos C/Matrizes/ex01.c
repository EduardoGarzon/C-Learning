/* 1. Faça um algoritmo para ler uma matriz 5x5. Em seguida crie uma matriz multiplicando
os elementos positivos da matriz inicial por k, e os negativos por q, sendo k e q informados pelo usuário.
...
int main()
{
    ...
    printf("\n\nMatriz Multiplicada | Positivos por %d e Negativos por %d\n", valor, valor2);
    for (i = 0; i < 5; i++)
    {
        printf("\n");
        for (j = 0; j < 5; j++)
