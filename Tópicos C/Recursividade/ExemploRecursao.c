/*
    ...
    Imprimindo intervalo de 0 ate N do inicio ao fim e do fim ao inicio.

    Uma funcao ou procedimento recursivo chama a si mesmo
    durante a execucao.

    É um processo de repeticao.

    O stop de uma funcao ou procedimento
    recursivo é quando nao ocorre mais a sua chamada.
*/
...
void imprimir_inicio(int numero)
{
    ...
    else
    {
        ...
        // apos o fim do procedimento é retornado
        // o processo de desempilhar dos valores empilhados.

        // empilhar    : base - 3, 2, 1, 0 - topo
        // desempilhar : topo - 0, 1, 2, 3 - topo
        // saida       : 0, 1, 2, 3

        // quando chega em 0 o print ocorre no processo de desempilha.r
