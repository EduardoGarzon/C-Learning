/*
    ...
    Aqui estão os detalhes de implementação 
    dos métodos declarados no arquivo de cabeçalho.
    
    O arquivo de implementação é onde você escreve 
    o código real dos métodos e realiza as operações desejadas.
*/
