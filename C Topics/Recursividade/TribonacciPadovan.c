...
// funcao recursiva para padovan
int padovan(int prev, int prevprev, int curr, int next, int n, int i)
{
    if (i > n)
    {
        return next;
...
// funcao recursiva para tribonacci
int trib(int prev, int prevprev, int curr, int next, int n, int i)
{
    if (i > n)
    {
        return next;
...
int main()
{
    ...
    // chamada da funcao recursiva padovan
    printf(" [%d]", padovan(prev, prevprev, curr, next, n, i));
    ...
    // chamada da funcao recursiva tribonacci
    printf(" [%d]", trib(prev, prevprev, curr, next, n, i));
