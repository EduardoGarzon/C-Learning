/*
    Construa uma lista encadeada para ler e manipular informações de
    cadastros de clientes (CPF, nome, ano de nascimento).
    Ao final todas as informações devem ser gravadas em um arquivo txt
    por ordem de ano de nascimento.
    Importante: que o usuário pode abrir este arquivo diversas
...
void inserirOrdenado(LISTA *lista) // funcao recebe o ponteiro do inicio
{
    ...
    { // percorre a lista ate o final ou ate que o novo seja menor que o proximo
        while (novo->ano > tmp->ano && tmp->prox != NULL)
        {
