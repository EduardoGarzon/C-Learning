...
int main()
{
    /*
        ...
        Dependendo do compilador ou IDE utilizada para executar o código, pode ocorrer de o terminal permanecer aberto apenas durante a execucao do processo fechando logo em seguida impossibilitando avaliar a saida gerada pelo codigo.
