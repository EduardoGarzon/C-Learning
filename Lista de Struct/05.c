/*
5. Escreva um trecho de código para fazer a criação dos novos tipos de dados
...
int main()
{
    ...
    while (resposta == 0 && i < 5)
    {
        ...
        while (flag_erro == 0) // teste de erro para verificar se é valido
        {
            ...
            {
                printf("\nArgumento invalido, tente novamente!\n"); // repete se nao passar no teste
            }
        }
    ...
    while (resposta == 0)
    {
        printf("\nInforme qual tarefa deseja acessar [0 - %d]: ", i);
        scanf("%d", &tarefa);
